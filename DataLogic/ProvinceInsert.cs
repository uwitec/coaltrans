...
namespace DataLogic
{
    ...
    public class ProvinceInsert : BaseExecute
    {
...
this.paraProID.Value = value;
        ...
        private SqlParameter paraProName;
        
        public string ProName
        {
            get
            {
return (System.String)this.paraProName.Value;
            }
            set
            {
this.paraProName.Value = value;
            }
        }
...
this.paraKeys.Value = value;
        ...
        public ProvinceInsert()
        {
base.InitCommand("ProvinceInsert");
ConfigParameter();
        }
...
//--------------------------------------------------------
this.paraProName = new SqlParameter();
this.paraProName.ParameterName = "@ProName";
this.paraProName.SqlDbType = SqlDbType.VarChar;
this.paraProName.Size = 50;
this.paraProName.Direction = ParameterDirection.Input;
this.paraProName.Value=DBNull.Value;
base.m_cmd.Parameters.Add(this.paraProName);
//--------------------------------------------------------
