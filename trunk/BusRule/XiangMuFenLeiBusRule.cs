...
namespace BusRule
{
    ...
    public class XiangMuFenLeiBusRule
    {
        
        public XiangMuFenLeiBusRule()
        {
        }
        ...
        // 物理删除由主键ID指定的一条记录 DeleteXiangMuFenLei
        public bool Delete(int ID)
        {
            XiangMuFenLeiDelete exec = new XiangMuFenLeiDelete();
            try
            {
                exec.ID = ID;
                exec.ExecNoQuery();
        ...
        // 公用静态方法，删除一条记录 DeleteXiangMuFenLei
        public static bool DeleteEntity(XiangMuFenLeiBusEntity obj)
        {
            if (obj == null || obj.IsEmpty)
            {
                return false;
