<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdList.aspx.cs" Inherits="CoalSysManage_Ad_AdList" %>
...
<body class="MainBody">
    ...
    <div class="HeadBar">
        <div class="HeadBarNav">后台管理中心&nbsp;<span>--&nbsp;广告列表</span></div>
        <div class="HeadBarOperate"><div class="Btn_Style1"><a href="AdEdit.aspx?ID=&act=add">添加广告</a></div></div>
    </div>
    <div class="SearchBar">
