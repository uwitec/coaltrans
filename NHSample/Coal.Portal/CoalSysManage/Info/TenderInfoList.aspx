<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TenderInfoList.aspx.cs" Inherits="CoalSysManage_Info_TenderInfoList" %>
...
<body class="MainBody">
    ...
    <div class="HeadBar">
        <div class="HeadBarNav">后台管理中心&nbsp;<span>--&nbsp;投标信息列表</span></div>
        <div class="HeadBarOperate"><div class="Btn_Style1"><a href="javascript:void(null);">添加投标信息</a></div></div>
    </div>
    <div class="SearchBar">
        <div style=" margin-left:50px;">&nbsp;</div>
        <div><b>投标标题：</b><input type="text" id="TenderTitle" runat="server" /></div>        
        ...
        <asp:Repeater ID="List" runat="server">
            ...
            <ItemTemplate>
                 <tr class="ListTableBody"  >
                        <td>
                        <asp:CheckBox ID="TenderID" runat="server" />
                        <asp:Label ID="ID" runat="server"    Text='<%# Eval("ID") %>'></asp:Label></td>
                    <td align="center"><%# Eval("TenderTitle")%></td>                        
                    ...
                    <td>
                        <span><a href="javascript:void(null);" title="查看" onclick='Display("DisplayDiv","TenderInfo","UserInfo","ID","UserId",<%# Eval("ID") %>,"TenderInfoList")'><img src="../images/icon_view.gif" alt="" /></a></span>
